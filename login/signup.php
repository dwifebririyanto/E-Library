...
function signUp($data)
{
    ...
    $querySignUp = "INSERT INTO member (username_member, nama_member, password, jenis_kelamin, fakultas, prodi, no_telepon) 
                    VALUES ('$username', '$nama', '$password', '$jk', '$fakultas', '$prodi', '$noTlp')";
